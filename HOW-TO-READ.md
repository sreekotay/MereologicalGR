...
```text
README        frame, glossary, lane rules
A0 §1–§7      roles, the ladder, compose / missing / extra
   §10–§12    import rules, ledger discipline, the four bets
A1            the seed run
...
failed floor:   attempted reduction did not deliver; logged as negative
parked texture: not evidence, not denied; live to revisit,
