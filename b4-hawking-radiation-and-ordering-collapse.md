...
external theory / calibration supplies:
  exact Hawking coefficient;
  greybody factors;
  species dependence;
  charge/spin/dimensional corrections;
  QG-completion terms;
...
S_rad(t):
  entropy of exterior radiation region;
  Page-curve diagnostic;
...
Singularity:
  unobserved;
  inferred as classical GR continuation-failure boundary;
