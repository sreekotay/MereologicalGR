...
| **Frontier (C)** | `c1`–`c7` | The non-coincident-cones line of inquiry: defusion attempts, kill-lanes, quantification, theory classes, formal spine, response family, and the relatedness seam; exposure ledgered in CLAIMS.md (CD rows); not canon |
