...
| **Frontier (C)** | `c1`–`c8` | The non-coincident-cones line of inquiry: defusion attempts, kill-lanes, quantification, theory classes, formal spine, response family, the relatedness seam, and conversion across the ladder; exposure ledgered in CLAIMS.md (CD rows); not canon |
